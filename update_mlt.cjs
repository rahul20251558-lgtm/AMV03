...
// Replace "border border-zinc-400" with "border border-zinc-300" globally to match other tabs
newContent = newContent.replace(/border-zinc-400/g, "border-zinc-300");
