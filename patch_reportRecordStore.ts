...
let content = fs.readFileSync('src/services/reportRecordStore.ts', 'utf-8');
content = `export function saveReportRecord(reportNo: string, productName: string) {
  try {
...
fs.writeFileSync('src/services/reportRecordStore.ts', content, 'utf-8');
